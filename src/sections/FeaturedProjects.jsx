...
const FeaturedProjects = () => {
  return (
    <section
      id="projects"
      className="projects-section relative px-4 sm:px-6 lg:px-8 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto">
        <div className="section-label reveal">Projects</div>

        <motion.div
          className="projects-section__heading text-center reveal"
          initial="hidden"
          whileInView="visible"
        ...
        >
          {/* <motion.h2
            variants={itemVariants}
            className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-3 pb-1 text-balance"
          >
            <span className="text-slate-900 dark:text-white">Featured </span>
            <span className="projects-heading-gradient inline-block">Projects</span>
          </motion.h2> */}
          
          <motion.div variants={itemVariants} className="projects-section__rule" />
        </motion.div>

        <motion.div
          className="mt-7 sm:mt-9 reveal"
          initial="hidden"
          whileInView="visible"
