...
// Define image paths using Vite's BASE_URL for public folder assets
const profilePic = `${import.meta.env.BASE_URL}images/profile-pic.jpeg`;
const profileDark = `${import.meta.env.BASE_URL}images/profile-dark.jpeg`;
...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    img.src = isDark ? profileDark : profilePic;
  ...
  const handleResumeClick = useCallback(() => {
    ...
    link.href = `${import.meta.env.BASE_URL}images/Resume.pdf`;
          ...
          >
            ...
            >
              ...
              >
                <img
                  ref={imgRef}
                  src={isDark ? profileDark : profilePic}
